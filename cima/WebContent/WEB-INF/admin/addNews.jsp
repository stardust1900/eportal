...
================================================== -->
  ...
  <form action="doAddNews.htm" method="post" class="form-horizontal"> 
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input name="news.title" id="news.title" type="text" class="form-control" placeholder="新闻标题">
    </div>
  </div>
  <div class="form-group">
    <label for="news.summary" class="col-sm-2 control-label">新闻摘要</label>
    <div class="col-sm-10">
      <input name="news.summary" id="news.summary" type="text" class="form-control" placeholder="新闻摘要">
    </div>
  </div>
  
  <div class="form-group">
  <label for="news.content" class="col-sm-2 control-label">产品介绍</label>
  <input type="hidden" name="news.content" id="newsContent" />
	  <div class="col-sm-10">
		   <div id="summernote">
		   </div>
	   </div>
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="button" class="btn btn-default" onclick="addNews()">确定</button>
