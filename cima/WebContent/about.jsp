...
================================================== -->
  <body>
	...
	<ul class="nav nav-tabs">
		<s:if test='%{aboutType=="p"}'>
			<li role="presentation" class="active"><a href="#"><s:text name="page.about.profile"/></a></li>
		</s:if>
		<s:else>
			<li role="presentation"><a href="about.htm?aboutType=p"><s:text name="page.about.profile"/></a></li>
		</s:else>
		<s:if test='%{aboutType=="h"}'>
			<li role="presentation" class="active"><a href="#"><s:text name="page.about.honors"/></a></li>
		</s:if>
		<s:else>
			<li role="presentation"><a href="about.htm?aboutType=h"><s:text name="page.about.honors"/></a></li>
		</s:else>
	</ul>
