      ...
      <div class="container">
        ...
        <div class="navbar navbar-inverse" role="navigation">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="news.htm"><s:text name="page.news"/></a></li>
                <li><a href="research.htm"><s:text name="page.research"/></a></li>
                <li><a href="contact.html"><s:text name="page.contract"/></a></li>
              </ul>
        ...
        <div class="panel panel-default">
          <div class="panel-body">
            <p class="lead text-center"><s:property value="news.title"/></p>
                <p/>
                <p class="text-center"><s:property value="news.content" escape="false"/></p>
                <p class="text-center"> <a href="news.htm?currentPage=<s:property value='currentPage'/>" class="btn btn-default" role="button"><s:text name="page.back"/></a></p>
          </div>
        </div>
